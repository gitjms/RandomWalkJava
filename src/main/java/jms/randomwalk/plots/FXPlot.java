    ...
    public void setFXPlot(String language, String which) {
        ...
        switch (which) {
            ...
            case "saw":
                ...
                this.getFrame().setPreferredSize(new Dimension(IntSizes.SAWSIZE.getIntSize(), IntSizes.HEIGHT.getIntSize()));
        ...
        */
        ...
        switch (which) {
            case "Walks&norm":
                ...
                this.getCalcChartW().getStyler().setAxisTickLabelsFont(new Font(null, Font.PLAIN, 13));
                this.getCalcChartW().getStyler().setDefaultSeriesRenderStyle(XYSeriesRenderStyle.Line);
                this.getCalcChartW().getStyler().setChartTitleFont(new Font(null, Font.PLAIN, 18));
                this.getCalcChartW().getStyler().setAxisTitleFont(new Font(null, Font.PLAIN, 15));
                this.getCalcChartW().getStyler().setLegendFont(new Font(null, Font.PLAIN, 16));
                ...
                this.getCalcChartN().getStyler().setAxisTickLabelsFont(new Font(null, Font.PLAIN, 13));
                this.getCalcChartN().getStyler().setDefaultSeriesRenderStyle(XYSeriesRenderStyle.Line);
                this.getCalcChartN().getStyler().setChartTitleFont(new Font(null, Font.PLAIN, 18));
                this.getCalcChartN().getStyler().setAxisTitleFont(new Font(null, Font.PLAIN, 15));
                this.getCalcChartN().getStyler().setLegendFont(new Font(null, Font.PLAIN, 16));
                ...
                this.getCalcChartH().getStyler().setAxisTickLabelsFont(new Font(null, Font.PLAIN, 13));
                this.getCalcChartH().getStyler().setChartTitleFont(new Font(null, Font.PLAIN, 18));
                this.getCalcChartH().getStyler().setAxisTitleFont(new Font(null, Font.PLAIN, 15));
            ...
            case "energy&diffusion":
                ...
                this.getCalcChartE().getStyler().setAxisTickLabelsFont(new Font(null, Font.PLAIN, 13));
                this.getCalcChartE().getStyler().setDefaultSeriesRenderStyle(XYSeriesRenderStyle.Line);
                this.getCalcChartE().getStyler().setChartTitleFont(new Font(null, Font.PLAIN, 18));
                this.getCalcChartE().getStyler().setAxisTitleFont(new Font(null, Font.PLAIN, 15));
                this.getCalcChartE().getStyler().setLegendFont(new Font(null, Font.PLAIN, 16));
                ...
                this.getCalcChartD().getStyler().setAxisTickLabelsFont(new Font(null, Font.PLAIN, 13));
                this.getCalcChartD().getStyler().setDefaultSeriesRenderStyle(XYSeriesRenderStyle.Line);
                this.getCalcChartD().getStyler().setChartTitleFont(new Font(null, Font.PLAIN, 18));
                this.getCalcChartD().getStyler().setAxisTitleFont(new Font(null, Font.PLAIN, 15));
                this.getCalcChartD().getStyler().setLegendFont(new Font(null, Font.PLAIN, 16));
                ...
                this.getCalcChartV().getStyler().setAxisTickLabelsFont(new Font(null, Font.PLAIN, 13));
                this.getCalcChartV().getStyler().setDefaultSeriesRenderStyle(XYSeriesRenderStyle.Line);
                this.getCalcChartV().getStyler().setChartTitleFont(new Font(null, Font.PLAIN, 18));
                this.getCalcChartV().getStyler().setAxisTitleFont(new Font(null, Font.PLAIN, 15));
                this.getCalcChartV().getStyler().setLegendFont(new Font(null, Font.PLAIN, 16));
            ...
            case "saw":
                ...
                this.getCalcChartS1().getStyler().setAxisTickLabelsFont(new Font(null, Font.PLAIN, 13));
                this.getCalcChartS1().getStyler().setDefaultSeriesRenderStyle(XYSeriesRenderStyle.Line);
                this.getCalcChartS1().getStyler().setChartTitleFont(new Font(null, Font.PLAIN, 18));
                this.getCalcChartS1().getStyler().setAxisTitleFont(new Font(null, Font.PLAIN, 15));
                this.getCalcChartS1().getStyler().setLegendFont(new Font(null, Font.PLAIN, 16));
                ...
                this.getCalcChartS2().getStyler().setAxisTickLabelsFont(new Font(null, Font.PLAIN, 13));
                this.getCalcChartS2().getStyler().setDefaultSeriesRenderStyle(XYSeriesRenderStyle.Line);
                this.getCalcChartS2().getStyler().setChartTitleFont(new Font(null, Font.PLAIN, 18));
                this.getCalcChartS2().getStyler().setAxisTitleFont(new Font(null, Font.PLAIN, 15));
                this.getCalcChartS2().getStyler().setLegendFont(new Font(null, Font.PLAIN, 16));
                ...
                this.getCalcChartS3().getStyler().setAxisTickLabelsFont(new Font(null, Font.PLAIN, 13));
                this.getCalcChartS3().getStyler().setChartTitleFont(new Font(null, Font.PLAIN, 18));
                this.getCalcChartS3().getStyler().setAxisTitleFont(new Font(null, Font.PLAIN, 15));
            ...
            case "eff":
                ...
                this.getCalcChartF().getStyler().setToolTipFont(new java.awt.Font(null, Font.PLAIN, 16));
                this.getCalcChartF().getStyler().setAxisTickLabelsFont(new Font(null, Font.PLAIN, 14));
                this.getCalcChartF().getStyler().setDefaultSeriesRenderStyle(XYSeriesRenderStyle.Scatter);
                this.getCalcChartF().getStyler().setChartTitleFont(new Font(null, Font.PLAIN, 20));
                this.getCalcChartF().getStyler().setLegendFont(new Font(null, Font.PLAIN, 20));
                this.getCalcChartF().getStyler().setAxisTitleFont(new Font(null, Font.PLAIN, 18));
