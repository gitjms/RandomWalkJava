    ...
    */
    ...
    String realtimesawEN() {
        ...
        return "\n Real Time Self Avoiding Walk\n"
            ...
            + " steps the walkers take while moving.\n\n"
            + " Dimension is either 2 or 3. Two means moving on a plane with\n"
            + " axes x and y, three means moving in a cube with axes x, y,\n\n"
            + " and z. Slider adjusts the amplitude 'A'.\n\n"
            + " ----------------------------------------------------------------\n\n"
            + " CHOICE BUTTONS:\n\n"
            + " - 'RUN SAW' loops a simple self-avoiding walk, during which\n"
            + "    there will be an image window with three real time plots:\n"
			...
			+ "    text input field box below the button. User may save the\n"
			+ "    image by right-clicking the mouse and choosing 'save'. Save\n"
            + "    formats are: 'png', 'jpg', 'bmp', 'gif', 'svg', 'eps', 'pdf'.\n\n"
            + " - 'PLOT' creates an image of self-avoiding walk path. Amount of\n"
            + "    runs to create a plot can be restricted in the input box\n"
            + "    below the button.\n\n"
            + " Button 'CLOSE' closes the application.\n";
    }
