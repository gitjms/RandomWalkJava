    ...
    */
    String menuFI() {
        ...
        return "\n Nappi 'LIIKERADAT' näyttää ohjauspaneelin, jolla käyttäjä voi\n"
            ...
            + " Yksi ajo tuottaa yhden datatiedoston päätteellä '.xy', joista kaksi\n"
    ...
    String menuEN() {
        ...
        return "\n Button 'PATH TRACING' will show a control panel with which user can\n"
            ...
            + " One run produces one data file ending with '.xy', of which two are\n"
            ...
            + " and final positions of particles. In that case there will be two\n"
    ...
    */
    String realtimermsFI() {
        ...
        return "\n Reaaliaikainen neliösummaetäisyys\n"
            ...
            + " jakauman.\n\n"
            + " Kummassakin edellä mainitussa vaihtoehdossa tulee esiin kaksi nappia,\n"
            + " joista saa kuvaajan eri laskukaavalla laskettuna.\n\n"
    ...
    String realtimermsEN() {
        ...
        return "\n Real Time Root Mean Squared Distance\n"
            ...
            + " plot.\n"
            + " Both of aforementioned options brings forth two buttons, with which \n"
            + " graphs can be calculated with different equations.\n\n"
    ...
    */
    ...
    String realtimesawFI() {
        ...
        return "\n Reaaliaikainen itseään välttelevä kulku\n"
            ...
            + " Liukukytkimellä voi säätää korjaustermiä 'C'.\n\n"
            + " ----------------------------------------------------------------\n\n"
            + " VALINTANAPIT:\n\n"
            ...
            + "    Tallennusmuodot: 'png', 'jpg', 'bmp', 'gif', 'svg', 'eps',\n"
            + "    'pdf'.\n\n"
            + " - 'KUVAAJA' luo kuvan itseään välttelevän kulun liikeradasta.\n"
    ...
    String realtimesawEN() {
        ...
        return "\n Real Time Self Avoiding Walk\n"
            ...
            + " Slider adjusts the correction term 'C'.\n\n"
            + " -----------------------------------------------------------------\n\n"
            + " CHOICE BUTTONS:\n\n"
            ...
            + "    'pdf'.\n\n"
            + " - 'RUN CBMC' loops configurational biased self-avoiding walk,\n"
